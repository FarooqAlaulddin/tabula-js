			...
			<aside className="sidebar">
					...
					<ul className="tab-list">
						{tabs.map((tab) => (
							<li key={tab.id} className="tab-item">
								<span
									className={`tab-dot ${tab.visible ? 'visible' : ''}`}
								/>
								...
								{tab.view && (
									<span className="badge badge-view">{tab.view}</span>
								)}
							</li>
						))}
					</ul>
				...
				<div className="sidebar-section">
					...
					<ul className="hooks-list">
						<li><code>useSharedState</code> — theme toggle</li>
						<li><code>useTabPresence</code> — tab list</li>
						<li><code>useLeader</code> — leader badge</li>
						<li><code>useTabView</code> — {view ? `"${view}"` : 'no view'}</li>
					</ul>
				</div>
				...
				<div className="sidebar-section">
					...
					<p className="sidebar-text">
						The Excalidraw component is used <strong>as-is</strong> — no
						modifications. A thin Tabula wrapper syncs the drawing data
						across tabs via BroadcastChannel.
					</p>
					<p className="sidebar-text">
						Click <strong>Expand to Tab</strong> to open a full-screen
						canvas. Draw in either tab — changes sync instantly.
					</p>
				</div>
			</aside>
